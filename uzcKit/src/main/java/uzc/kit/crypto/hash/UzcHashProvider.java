...
public class UzcHashProvider extends Provider {

    private static final String NAME = "UzcHashProvider";
    private static final double VERSION = 1.0;
    private static final String INFO = "A Shabal-256 MessageDigest provider";

    public static void init() {
        Security.addProvider(new UzcHashProvider());
    }

    private UzcHashProvider() {

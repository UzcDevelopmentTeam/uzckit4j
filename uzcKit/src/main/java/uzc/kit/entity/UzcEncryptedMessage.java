...
public final class UzcEncryptedMessage {
     ...
     */
    public UzcEncryptedMessage(byte[] data, byte[] nonce, boolean isText) {
        this.data = data;
        this.nonce = nonce;
        this.isText = isText;
    }
    ...
    public byte[] decrypt(String myPassphrase, byte[] theirPublicKey) {
        return UzcCrypto.getInstance().decryptMessage(this, myPassphrase, theirPublicKey);
    }
    ...
    public byte[] decrypt(byte[] myPrivateKey, byte[] theirPublicKey) {
        return UzcCrypto.getInstance().decryptMessage(this, myPrivateKey, theirPublicKey);
    }
